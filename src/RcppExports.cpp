...
// pot_MALA
double pot_MALA(arma::vec R, arma::mat X1, arma::mat X2, arma::vec param, arma::mat S1, arma::mat S2, double sigma_sq, double delta_sq, double pen_param);
RcppExport SEXP _SynIntTest_pot_MALA(SEXP RSEXP, SEXP X1SEXP, SEXP X2SEXP, SEXP paramSEXP, SEXP S1SEXP, SEXP S2SEXP, SEXP sigma_sqSEXP, SEXP delta_sqSEXP, SEXP pen_paramSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type R(RSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(pot_MALA(R, X1, X2, param, S1, S2, sigma_sq, delta_sq, pen_param));
    return rcpp_result_gen;
END_RCPP
}
// grad_MALA
arma::vec grad_MALA(arma::vec R, arma::mat X1, arma::mat X2, arma::vec param, arma::mat S1, arma::mat S2, double sigma_sq, double delta_sq, double pen_param);
RcppExport SEXP _SynIntTest_grad_MALA(SEXP RSEXP, SEXP X1SEXP, SEXP X2SEXP, SEXP paramSEXP, SEXP S1SEXP, SEXP S2SEXP, SEXP sigma_sqSEXP, SEXP delta_sqSEXP, SEXP pen_paramSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type R(RSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type delta_sq(delta_sqSEXP);
    Rcpp::traits::input_parameter< double >::type pen_param(pen_paramSEXP);
    rcpp_result_gen = Rcpp::wrap(grad_MALA(R, X1, X2, param, S1, S2, sigma_sq, delta_sq, pen_param));
    return rcpp_result_gen;
END_RCPP
}
// sq_sampler
Rcpp::List sq_sampler(arma::vec R, arma::mat X1, arma::mat X2, arma::mat S1, arma::mat S2, double sigma_sq, double delta_sq, arma::vec old_param, double eps_MALA, arma::mat precond_mat, arma::mat precond_mat_inv, int L_HMC, double pen_param);
RcppExport SEXP _SynIntTest_sq_sampler(SEXP RSEXP, SEXP X1SEXP, SEXP X2SEXP, SEXP S1SEXP, SEXP S2SEXP, SEXP sigma_sqSEXP, SEXP delta_sqSEXP, SEXP old_paramSEXP, SEXP eps_MALASEXP, SEXP precond_matSEXP, SEXP precond_mat_invSEXP, SEXP L_HMCSEXP, SEXP pen_paramSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::vec >::type R(RSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type pen_param(pen_paramSEXP);
    rcpp_result_gen = Rcpp::wrap(sq_sampler(R, X1, X2, S1, S2, sigma_sq, delta_sq, old_param, eps_MALA, precond_mat, precond_mat_inv, L_HMC, pen_param));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_SynIntTest_SIDsampler_draws_adaptive_optimized", (DL_FUNC) &_SynIntTest_SIDsampler_draws_adaptive_optimized, 27},
    {NULL, NULL, 0}
};
